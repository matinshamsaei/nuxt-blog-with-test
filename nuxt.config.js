...
export default {
  ...
  head: {
    ...
    link: [
      ...
      { rel: 'stylesheet', href: 'https://fonts.googleapis.com/css2?family=Grandstander:wght@200;400&display=swap' }
    ]
  },
  ...
  generate: {
    routes: function () {
      return axios.get('https://nuxt-blog-a8c37.firebaseio.com/posts.json')
        .then(res => {
          const routes = [];
